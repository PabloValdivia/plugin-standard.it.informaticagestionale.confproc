...
/** Generated Model for CP_ProcessSubFlowState
 *  @author Adempiere (generated) 
 *  @version Release 3.4.0s - $Id$ */
public class X_CP_ProcessSubFlowState extends PO implements I_CP_ProcessSubFlowState, I_Persistent 
{
    ...
    public X_CP_ProcessSubFlowState (Properties ctx, int CP_ProcessSubFlowState_ID, String trxName)
    {
      super (ctx, CP_ProcessSubFlowState_ID, trxName);
      /** if (CP_ProcessSubFlowState_ID == 0)
        {
			setCP_ProcessSubFlowState_ID (0);
        } */
    }

    /** Load Constructor */
    public X_CP_ProcessSubFlowState (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_CP_ProcessSubFlowState[")
	...
	public void setCP_ProcessSubFlowState_ID (int CP_ProcessSubFlowState_ID)
	{
		...
		set_ValueNoCheck (COLUMNNAME_CP_ProcessSubFlowState_ID, Integer.valueOf(CP_ProcessSubFlowState_ID));
	}
